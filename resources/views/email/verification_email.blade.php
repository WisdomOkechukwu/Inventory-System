...
>
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css?family=DM+Sans:ital,wght@0,400;0,400;0,500;0,600;0,700;0,800"
      rel="stylesheet"
    />
    ...
    <style>
      ...
      @font-face {
        ...
        font-style: normal;
        font-weight: 600;
        src: url('https://fonts.gstatic.com/s/dmsans/v15/rP2tp2ywxg089UriI5-g4vlH9VoD8CmcqZG40F9JadbnoEwAfJtRR23w.woff')
            format('woff'),
          url('https://fonts.gstatic.com/s/dmsans/v15/rP2tp2ywxg089UriI5-g4vlH9VoD8CmcqZG40F9JadbnoEwAfJtRR232.woff2')
            format('woff2');
      }
  ...
  >
    <table
      ...
      style="table-layout: fixed; min-width: 600px; background-color: #ffc627"
      bgcolor="#ffc627"
      width="100%"
      border="0"
      cellspacing="0"
                            ...
                            >
                              <tr>
                                ...
                                <td
                                  ...
                                  style="
                                    background-image: url('https://cloudfilesdm.com/postcards/image-1737475989279.png');
                                  ...
                                  "
                                  bgcolor="#f3f3f3"
                                  background="https://cloudfilesdm.com/postcards/image-1737475989279.png"
                                >
                                  <!--<![endif]-->
                                  <!--[if gte mso 9]> <td valign="top" align="center" style="background-image: url('https://cloudfilesdm.com/postcards/image-1737475989279.png'); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #f3f3f3; border-radius: 0px;" bgcolor="#f3f3f3" background="https://cloudfilesdm.com/postcards/image-1737475989279.png"> <![endif]-->
                                  <!--[if gte mso 9]> <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;"> <v:fill src="https://cloudfilesdm.com/postcards/image-1737475989279.png" color="#f3f3f3" type="frame" size="1,1" aspect="atleast" origin="0,0" position="0,0"/> <v:textbox style="mso-fit-shape-to-text: true;" inset="0,0,0,0"> <div style="font-size: 0; line-height: 0;"> <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"> <tr> <td style="font-size: 14px; line-height: 1.5;" valign="top"> <p style="margin:0;mso-hide:all"><o:p xmlns:o="urn:schemas-microsoft-com:office:office">&nbsp;</o:p></p> <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation"> <tr> <td colspan="3" height="40" style="line-height: 1px; font-size: 1px;">&nbsp;</td> </tr> <tr> <td width="16" valign="top" style="line-height: 1px; font-size: 1px;">&nbsp;</td> <td valign="top" align="left"> <![endif]-->
                                  <table
                                    width="100%"
                                    border="0"
                                    cellpadding="0"
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        ...
                                        >
                                          <!-- <img
                                            src="https://cloudfilesdm.com/postcards/image-17332368908210.png"
                                            width="105"
                                            height="25"
                                            alt=""
                                            style="
                                              ...
                                              >
                                                <tr>
                                                  <td
                                                    ...
                                                    align="center"
                                                    valign="middle"
                                                    background="https://cloudfilesdm.com/postcards/image-17332368911451.png"
                                                    style="
                                                      padding: 10px 0px 0px 32px;
                                                      mso-padding-left-alt: 0;
                                                      margin-left: 32px;
                                                      background-image: url('https://cloudfilesdm.com/postcards/image-17332368911451.png');
                                                      background-size: cover;
                                                                                ...
                                                                                >
                                                                                  ...
                                                                                  >
                                                                                    <tr>
                                                                                      ...
                                                                                      >
                                                                                        <img
                                                                                          src="https://cloudfilesdm.com/postcards/image-1737475969934.png"
