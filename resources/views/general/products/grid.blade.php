...
@section('content')
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-6">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item fw-medium"><a href="javascript: void(0);" class="text-dark">All
                                        Products</a></li>
                            </ol>
                            <p class="mb-0 text-muted">Showing all <span class="text-dark fw-semibold">5,786</span> items
                                results</p>
                        </div>
                        <div class="col-lg-6">
                            <div class="text-md-end mt-3 mt-md-0">
                                <a href="{{ route('third', ['general', 'products', 'create']) }}"
                                    class="btn btn-primary me-1"><i class="bx bx-plus"></i> New Product</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body bg-light-subtle rounded-bottom">
                            <a href="{{ route('third', ['general', 'products', 'detail']) }}"
                                class="text-dark fw-medium fs-16">Men Black Slim Fit T-shirt</a>
                            <div class="my-1">
                            </div>
                            <h4 class="fw-semibold text-dark mt-2 d-flex align-items-center gap-2">
                                <span class=" text-decoration">N5,000</small>
                            </h4>
                            <div class="mt-3">
                                <div class="d-flex gap-2">
                                    <a href="{{ route('third', ['general', 'orders', 'cart']) }}"
        ...
        <div class="col-lg-4">
                        ...
                        <div class="row gy-3">
                            <div class="col-sm-auto">
                                <div class="rounded bg-light avatar-lg d-flex align-items-center justify-content-center">
                                    <img src="/images/product/p-1.png" alt="" class="avatar-lg">
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="ms-lg-3">
                            ...
                            <div class="col-sm-auto">
                                <div class="text-lg-end">
                                    <p class="fw-medium mb-0">Unit Price</p>
                                    <p class="mt-2 mb-0 fw-semibold fs-17">$80.00 </p>
                                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-sm">
                                <div class="d-flex gap-3">
                                    <a href="#!"
                                        class="text-dark fs-14 d-flex align-items-center gap-1"><iconify-icon
                                            icon="solar:trash-bin-minimalistic-bold-duotone"
                                            class="fs-18"></iconify-icon> Remove</a>
                                </div>
                            </div>
                            <div class="col-sm-auto">
            ...
            <div class="card text-center bg-primary overflow-hidden z-1">
                <div class="card-body p-4">
                    <h4 class="card-title text-white">Authorize Purchase</h4>
                        ...
                        <div class="form-button">
                            <form class="d-flex align-items-center justify-content-center">
                                <button type="button" data-toast data-toast-text="Your Promo Code Apply Successfully"
                                    ...
                                    data-toast-duration="3000" class="btn btn-light ms-2 rounded-2">
                                    Completed VIA POS
                                </button>
                                <button type="button" data-toast data-toast-text="Your Promo Code Apply Successfully"
                                    data-toast-gravity="top" data-toast-position="center" data-toast-className="success"
                ...
                <div class="position-absolute top-100 start-100 translate-middle z-n1 opacity-75">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                        xmlns:svgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800" width="400" height="400">
                        <defs>
    ...
    <style>
        /* Add styles for the scrollable-row */
        .scrollable-row {
            max-height: 400px;
        ...
        .scrollable-row:hover {
            overflow-y: auto;
            /* Enable vertical scrolling on hover */
            max-height: 600px;
            /* Optional: Increase max height on hover */
        }
